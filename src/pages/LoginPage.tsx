      ...
      <div className="w-full max-w-md bg-white rounded-3xl border border-border-base shadow-xl shadow-primary/5 p-8 md:p-12 space-y-8">
        ...
        <div className="space-y-4">
          <button className="w-full py-3 px-4 bg-white border border-border-base rounded-xl font-bold text-text-primary hover:bg-bg-main transition-all flex items-center justify-center gap-3">
            <Chrome size={20} className="text-primary" /> Continue with Google
          </button>
          <button className="w-full py-3 px-4 bg-white border border-border-base rounded-xl font-bold text-text-primary hover:bg-bg-main transition-all flex items-center justify-center gap-3">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-2 text-text-secondary font-bold">Or continue with email</span></div>
        </div>
        ...
        <p className="text-center text-sm text-text-secondary">
          Don't have an account? <Link to="/auth/register" className="text-primary font-bold hover:underline">Sign up for free</Link>
        </p>
      </div>
    </div>
  );
